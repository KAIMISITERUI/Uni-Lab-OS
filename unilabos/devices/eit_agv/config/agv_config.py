...
# 路径导航命令
REQ_CMD_ROBOT_TASK_PAUSE = 0x0BB9  # 暂停当前导航命令 (3001)
RSP_CMD_ROBOT_TASK_PAUSE = 0x32C9  # 暂停当前导航响应 (13001)
REQ_CMD_ROBOT_TASK_RESUME = 0x0BBA  # 继续当前导航命令 (3002)
RSP_CMD_ROBOT_TASK_RESUME = 0x32CA  # 继续当前导航响应 (13002)
REQ_CMD_ROBOT_TASK_CANCEL = 0x0BBB  # 取消当前导航命令 (3003)
RSP_CMD_ROBOT_TASK_CANCEL = 0x32CB  # 取消当前导航响应 (13003)
